...
export function sidebar() {
  ...
  sidebarInner.innerHTML = `
    ...
    <div class="sidebar-footer">
      <p class="copyright">
        Copyright 2024
        <a href="https://mohamedkhire.vercel.app/" target="_blank">Mohamed Khire</a>
      </p>
      <img src="./assets/images/mindx-icon - Copy.ico" width="130" height="17" alt="the movie database logo" />
    </div>
  `;
